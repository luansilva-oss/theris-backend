...
exports.syncStructureFromUsers = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const syncStructureFromUsers = async () => {
    ...
    try {
        ...
        for (const deptName of uniqueDepartments) {
            ...
            const rolesInDept = [...new Set(users.filter(u => u.department === deptName).map(u => u.jobTitle).filter(Boolean))];
...
exports.syncStructureFromUsers = syncStructureFromUsers;
