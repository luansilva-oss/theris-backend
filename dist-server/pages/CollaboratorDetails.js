...
const CollaboratorDetails = ({ id, onBack, onOpenAuditHistory }) => {
                    ...
                    fontSize: 14,
                            ...
                            top: 24,
                                    ...
                                    marginBottom: 16,
                                        ...
                                        alignItems: 'center',
                                        gap: 6,
                                    }, children: [user.isActive && (0, jsx_runtime_1.jsx)("span", { style: { width: 6, height: 6, borderRadius: '50%', background: 'currentColor', animation: 'pulse 1.5s ease-in-out infinite' } }), user.isActive ? 'Ativo' : 'Inativo'] }) }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', flexDirection: 'column', gap: 12, fontSize: 14, color: '#e4e4e7' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Briefcase, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsx)("span", { children: user.role?.name || user.jobTitle || '—' })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Building2, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsxs)("span", { children: ["Depto: ", user.departmentRef?.name || '—'] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Building2, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsxs)("span", { children: ["Unidade: ", user.unitRef?.name || '—'] })] }), user.role?.code && ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Hash, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsx)("span", { children: user.role.code })] })), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Mail, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsx)("a", { href: `mailto:${user.email}`, style: { color: '#a78bfa', textDecoration: 'none' }, children: user.email })] }), user.manager && ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: 10 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.User, { size: 16, color: "#71717a", style: { flexShrink: 0 } }), (0, jsx_runtime_1.jsxs)("span", { children: ["Gestor: ", user.manager.name] })] }))] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { background: '#18181b', borderRadius: 12, border: '1px solid #27272a', overflow: 'hidden' }, children: [(0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', borderBottom: '1px solid #27272a' }, children: ['acessos', 'historico', 'timeline'].map(tab => ((0, jsx_runtime_1.jsxs)("button", { onClick: () => setActiveTab(tab), style: {
                                        padding: '14px 20px',
                                        ...
                                        fontSize: 14,
                                        fontWeight: 500,
                                    }, children: [tab === 'acessos' && 'Acessos', tab === 'historico' && 'Histórico', tab === 'timeline' && 'Linha do tempo'] }, tab))) }), (0, jsx_runtime_1.jsxs)("div", { style: { padding: 24 }, children: [activeTab === 'acessos' && ((0, jsx_runtime_1.jsx)("div", { children: kbsFerramentas.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: { color: '#71717a', fontSize: 14 }, children: "Nenhum acesso cadastrado" })) : ((0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: kbsFerramentas.map((f, idx) => ((0, jsx_runtime_1.jsxs)("div", { style: {
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    gap: 16,
                                                    padding: 12,
                                                    ...
                                                    borderRadius: 8,
                                                    border: '1px solid #27272a',
                                                }, children: [(0, jsx_runtime_1.jsx)("span", { style: { flex: 1, color: '#e4e4e7', fontWeight: 500 }, children: f.ferramenta }), (0, jsx_runtime_1.jsx)("span", { style: { color: '#a1a1aa', fontSize: 13 }, children: f.sigla }), (0, jsx_runtime_1.jsx)("span", { style: { color: '#a78bfa', fontSize: 13 }, children: f.nivel }), f.critico && ((0, jsx_runtime_1.jsx)("span", { style: { padding: '2px 8px', borderRadius: 4, fontSize: 11, background: 'rgba(239, 68, 68, 0.2)', color: '#ef4444' }, children: "Cr\u00EDtico" }))] }, idx))) })) })), activeTab === 'historico' && ((0, jsx_runtime_1.jsx)(EntityAuditHistory_1.EntityAuditHistory, { entidadeId: user.id, entidadeTipo: "User", limit: 10, onOpenFullHistory: onOpenAuditHistory ? (p) => onOpenAuditHistory(p.entidadeId, p.entidadeTipo) : undefined })), activeTab === 'timeline' && ((0, jsx_runtime_1.jsx)("div", { children: historicoCargos.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: { color: '#71717a', fontSize: 14 }, children: "Nenhuma mudan\u00E7a de cargo registrada" })) : ((0, jsx_runtime_1.jsx)("ul", { style: { listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 12 }, children: historicoCargos.map(h => {
