...
const EditUserModal = ({ isOpen, onClose, user, onUpdate, currentUser, allUsers, showToast }) => {
    ...
    const [unit, setUnit] = (0, react_1.useState)(user.unit);
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "modal-overlay", children: (0, jsx_runtime_1.jsxs)("div", { className: "modal-content", style: { maxWidth: '500px' }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "modal-header", children: [(0, jsx_runtime_1.jsx)("h2", { children: "Editar Colaborador" }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, className: "btn-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.X, { size: 20 }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Nome Completo" }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", value: name, onChange: (e) => setName(e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "E-mail" }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", value: email, onChange: (e) => setEmail(e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Unidade" }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", value: unit || '', onChange: (e) => setUnit(e.target.value), placeholder: "Ex: 3C+, Dizify" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("label", { children: "Departamento" }), (0, jsx_runtime_1.jsxs)("select", { className: "form-input", value: department, onChange: (e) => {
                                        setDepartment(e.target.value);
                                        setRoleId(null);
                                        setJobTitle('');
                                    }, style: { width: '100%', fontSize: 13 }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Selecione..." }), availableDepts.map(d => (0, jsx_runtime_1.jsx)("option", { value: d.name, children: d.name }, d.id))] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("label", { children: "Cargo" }), (0, jsx_runtime_1.jsxs)("select", { className: "form-input", value: roleId || '', onChange: (e) => {
                                    ...
                                    .map(u => ((0, jsx_runtime_1.jsxs)("option", { value: u.id, children: [u.name, " (", u.jobTitle || 'Sem Cargo', ")"] }, u.id)))] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginTop: '20px', display: 'flex', gap: '10px' }, children: [(0, jsx_runtime_1.jsx)("button", { className: "btn-verify", style: { margin: 0, flex: 1 }, disabled: isSaving, onClick: handleSave, children: isSaving ? 'Salvando...' : 'Salvar Alterações' }), (0, jsx_runtime_1.jsx)("button", { className: "btn-verify", style: { margin: 0, background: 'transparent', border: '1px solid #374151', color: '#9CA3AF' }, onClick: onClose, children: "Cancelar" })] })] }) }));
};
