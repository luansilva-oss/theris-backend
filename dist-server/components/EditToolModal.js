...
const EditToolModal = ({ isOpen, onClose, tool, onUpdate }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "modal-overlay", children: (0, jsx_runtime_1.jsxs)("div", { className: "modal-content", style: { maxWidth: '800px', width: '90%', height: '80vh', display: 'flex', flexDirection: 'column' }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "modal-header", children: [(0, jsx_runtime_1.jsxs)("h2", { children: ["Editar ", tool.name] }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, className: "btn-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.X, { size: 20 }) })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', borderBottom: '1px solid #27272a', marginBottom: 20 }, children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => setActiveTab('IDENTITY'), style: {
                                ...
                                cursor: 'pointer',
                                fontWeight: 600
                            }, children: "Acessos & Pessoas" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { flex: 1, overflowY: 'auto', paddingRight: 10 }, children: [activeTab === 'IDENTITY' && ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', flexDirection: 'column', gap: 20 }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Nome do Sistema" }), (0, jsx_runtime_1.jsx)("input", { value: name, onChange: e => setName(e.target.value), className: "mfa-input-single", style: { width: '100%', textAlign: 'left', fontSize: 14 } })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Sigla / Acr\u00F4nimo" }), (0, jsx_runtime_1.jsx)("input", { value: acronym, onChange: e => setAcronym(e.target.value), className: "mfa-input-single", style: { width: '100%', textAlign: 'left', fontSize: 14 }, placeholder: "Ex: AWS" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Grupo / Categoria" }), !newGroupMode ? ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: 10 }, children: [(0, jsx_runtime_1.jsxs)("select", { value: groupId, onChange: e => setGroupId(e.target.value), className: "mfa-input-single", style: { width: '100%', fontSize: 14 }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Sem Grupo" }), availableGroups.map(g => (0, jsx_runtime_1.jsx)("option", { value: g.id, children: g.name }, g.id))] }), (0, jsx_runtime_1.jsxs)("button", { onClick: () => setNewGroupMode(true), className: "btn-mini", style: { whiteSpace: 'nowrap' }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Plus, { size: 14 }), " Novo Grupo"] })] })) : ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: 10 }, children: [(0, jsx_runtime_1.jsx)("input", { value: newGroupName, onChange: e => setNewGroupName(e.target.value), placeholder: "Nome do novo grupo", className: "mfa-input-single", style: { width: '100%', fontSize: 14 } }), (0, jsx_runtime_1.jsx)("button", { onClick: createGroup, className: "btn-mini approve", children: "Criar" }), (0, jsx_runtime_1.jsx)("button", { onClick: () => setNewGroupMode(false), className: "btn-mini reject", children: "Cancelar" })] }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Owner (Dono do Produto)" }), (0, jsx_runtime_1.jsxs)("select", { value: ownerId, onChange: e => setOwnerId(e.target.value), className: "mfa-input-single", style: { width: '100%', fontSize: 14 }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Selecione..." }), allUsers.map(u => (0, jsx_runtime_1.jsx)("option", { value: u.id, children: u.name }, u.id))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { children: "Sub-Owner (T\u00E9cnico / Backup)" }), (0, jsx_runtime_1.jsxs)("select", { value: subOwnerId, onChange: e => setSubOwnerId(e.target.value), className: "mfa-input-single", style: { width: '100%', fontSize: 14 }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Selecione..." }), allUsers.map(u => (0, jsx_runtime_1.jsx)("option", { value: u.id, children: u.name }, u.id))] })] }), (0, jsx_runtime_1.jsx)("div", { style: { marginTop: 20, paddingTop: 20, borderTop: '1px solid #27272a' }, children: (0, jsx_runtime_1.jsx)("button", { onClick: handleSaveIdentity, disabled: isSaving, className: "btn-verify", style: { width: 'auto', padding: '10px 30px' }, children: isSaving ? 'Salvando...' : 'Salvar Alterações' }) })] })), activeTab === 'ACCESS' && ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', flexDirection: 'column', gap: 20 }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "card-base", style: { background: '#18181b', border: '1px solid #27272a' }, children: [(0, jsx_runtime_1.jsx)("h4", { style: { color: 'white', margin: '0 0 10px 0' }, children: "N\u00EDveis de Acesso Dispon\u00EDveis" }), (0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 10 }, children: accessLevels.map(lvl => ((0, jsx_runtime_1.jsx)("span", { style: { background: '#3f3f46', padding: '4px 8px', borderRadius: 4, fontSize: 12, display: 'flex', alignItems: 'center', gap: 6 }, children: lvl }, lvl))) }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: 10 }, children: [(0, jsx_runtime_1.jsx)("input", { id: "newLevelInput", placeholder: "Novo n\u00EDvel (ex: Auditor)", className: "mfa-input-single", style: { flex: 1, fontSize: 13, height: 36 } }), (0, jsx_runtime_1.jsx)("button", { onClick: () => {
