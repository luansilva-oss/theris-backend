...
const ManageLevelModal = ({ isOpen, onClose, tool, levelName, onUpdate, showToast, customConfirm }) => {
    ...
    const kbsMembersByLevel = tool.kbsMembersByLevel;
    const kbsUsersForLevel = (kbsMembersByLevel || []).find((k) => (k.level || '').trim().toLowerCase() === (levelName || '').trim().toLowerCase())?.users ?? [];
    (0, react_1.useEffect)(() => {
        if (levelName) {
                            ...
                            boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.5)'
                                    ...
                                    margin: '0 auto 16px'
                                            ...
                                            fontWeight: 500
                                                    ...
                                                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                    flex: 1
                                                }, className: "hover:bg-zinc-800", children: [(0, jsx_runtime_1.jsx)("span", { style: { marginRight: 6 }, children: ic === 'Crown' ? (0, jsx_runtime_1.jsx)(lucide_react_1.Crown, { size: 16, color: icon === ic ? '#38BDF8' : '#71717a' }) : (0, jsx_runtime_1.jsx)(lucide_react_1.Shield, { size: 16, color: icon === ic ? '#38BDF8' : '#71717a' }) }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 13, color: icon === ic ? '#f4f4f5' : '#71717a', fontWeight: 500 }, children: ic === 'Crown' ? 'Coroa (Admin)' : 'Escudo (User)' })] }, ic))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("label", { children: "Descri\u00E7\u00E3o / Permiss\u00F5es" }), (0, jsx_runtime_1.jsx)("textarea", { value: description, onChange: e => setDescription(e.target.value), className: "form-input", style: { width: '100%', minHeight: 60 }, placeholder: "O que este n\u00EDvel pode fazer?" })] })] }), kbsUsersForLevel.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "card-base", style: { background: 'rgba(34, 197, 94, 0.06)', border: '1px solid rgba(34, 197, 94, 0.2)' }, children: [(0, jsx_runtime_1.jsx)("h4", { style: { color: '#22c55e', marginBottom: 10, fontSize: 13 }, children: "Herdados via Cargo (KBS)" }), (0, jsx_runtime_1.jsx)("p", { style: { color: '#71717a', fontSize: 12, marginBottom: 12 }, children: "Estes colaboradores recebem este n\u00EDvel por padr\u00E3o atrav\u00E9s da Gest\u00E3o de Pessoas. Somente leitura." }), (0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8 }, children: kbsUsersForLevel.map((u) => ((0, jsx_runtime_1.jsxs)("div", { style: {
                                            background: '#18181b',
                                            ...
                                            fontSize: 13,
                                            color: '#e4e4e7'
                                        }, children: [(0, jsx_runtime_1.jsx)("span", { children: u.name }), u.email && (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 11, color: '#71717a' }, children: u.email })] }, u.id))) })] })), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("h4", { style: { color: '#d4d4d8', marginBottom: 12 }, children: ["Gerenciar Membros (", usersInLevel.length, ")"] }), (0, jsx_runtime_1.jsxs)("div", { style: { position: 'relative', marginBottom: 16 }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Search, { size: 14, style: { position: 'absolute', left: 12, top: 11, color: '#71717a' } }), (0, jsx_runtime_1.jsx)("input", { value: searchTerm, onChange: e => setSearchTerm(e.target.value), className: "form-input", placeholder: "Adicionar pessoa a este n\u00EDvel...", style: { width: '100%', paddingLeft: 34 } }), searchTerm && ((0, jsx_runtime_1.jsx)("div", { style: { position: 'absolute', top: 40, left: 0, right: 0, background: '#18181b', border: '1px solid #27272a', borderRadius: 8, zIndex: 20, maxHeight: 150, overflowY: 'auto' }, children: filteredUsers.map(u => ((0, jsx_runtime_1.jsxs)("div", { onClick: () => addUser(u.id), style: { padding: '10px 12px', borderBottom: '1px solid #27272a', cursor: 'pointer', color: '#e4e4e7', fontSize: 13, display: 'flex', justifyContent: 'space-between' }, className: "hover:bg-zinc-800", children: [(0, jsx_runtime_1.jsx)("span", { children: u.name }), (0, jsx_runtime_1.jsx)(lucide_react_1.Plus, { size: 14, color: "#0EA5E9" })] }, u.id))) }))] }), (0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 }, children: usersInLevel.length === 0 && kbsUsersForLevel.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: { padding: 20, textAlign: 'center', color: '#52525b', fontSize: 13, border: '1px solid #27272a', borderRadius: 8 }, children: "Nenhum usu\u00E1rio neste n\u00EDvel." })) : usersInLevel.length === 0 ? null : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8 }, children: (showAllUsers ? usersInLevel : usersInLevel.slice(0, 5)).map((u) => ((0, jsx_runtime_1.jsxs)("div", { style: {
                                                        background: '#27272a',
                                                        border: '1px solid #3f3f46',
                                                        borderRadius: 20,
                                                        padding: '6px 12px',
