...
const PersonnelListView = ({ units: unitsFromApi, users, departments, roles, onEditUser, onDeleteUser, onEditDepartment, onDeleteDepartment, onEditRole, onDeleteRole, onAddCollaborator, onAddRole, onAddDepartmentToUnit, onEditUnit, onDeleteUnit }) => {
