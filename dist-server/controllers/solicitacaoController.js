...
exports.updateSolicitacao = exports.getSolicitacoes = exports.createSolicitacao = void 0;
    ...
    try {
        ...
        if (action === 'REPROVADO') {
            ...
            if (request.requester.email) {
                ...
                (0, slackService_1.sendSlackNotification)(request.requester.email, 'REPROVADO', adminNote || 'Reprovado pelo administrador.', request.type, ownerName);
            }
        ...
        // Notificação Slack
        if (request.requester.email) {
            (0, slackService_1.sendSlackNotification)(request.requester.email, 'APROVADO', adminNote || 'Solicitação aprovada e executada.', request.type);
        }
        // =========================================================
