...
const TIPO_OPTIONS_GROUPS: { label: string; options: string[] }[] = [
  ...
  { label: 'Acessos (AEX)', options: ['AEX_CREATED', 'AEX_OWNER_APPROVED', 'AEX_OWNER_REJECTED', 'AEX_SI_APPROVED', 'AEX_SI_REJECTED', 'AEX_APPROVED', 'AEX_AUTO_REJECTED', 'AEX_EXPIRED', 'AEX_RECERTIFICATION_REVOKED', 'AEX_SUPERSEDED'] },
...
function getBadgeColor(tipo: string): string {
  if (tipo === 'AEX_SUPERSEDED') return '#f97316';
  ...
  const vermelho = ['LOGIN_FAILED', 'MFA_FAILED', 'SESSION_EXPIRED', 'USER_OFFBOARDED', 'AEX_OWNER_REJECTED', 'AEX_SI_REJECTED', 'AEX_AUTO_REJECTED', 'AEX_EXPIRED', 'AEX_RECERTIFICATION_REVOKED', 'DEPARTMENT_DELETED', 'UNIT_DELETED', 'ROLE_DELETED', 'SESSION_REVOKED', 'BULK_SESSION_REVOKED', 'TICKET_REOPENED'];
