...
const TIPO_OPTIONS_GROUPS: { label: string; options: string[] }[] = [
  ...
  { label: 'Acessos (AEX)', options: ['AEX_CREATED', 'AEX_OWNER_APPROVED', 'AEX_OWNER_REJECTED', 'AEX_SI_APPROVED', 'AEX_SI_REJECTED', 'AEX_APPROVED', 'AEX_AUTO_REJECTED', 'AEX_EXPIRED', 'AEX_RECERTIFICATION_REVOKED'] },
